# Creating an Elastic Kubernetes Service (EKS) Cluster on AWS using Terraform

#### Project Overview
This Peoject can be broken down into a series of steps. Here's a comprehensive guide with clear instructions for each part of the process:
